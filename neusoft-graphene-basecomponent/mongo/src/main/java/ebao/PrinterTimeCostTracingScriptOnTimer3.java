...
@BTrace
public class PrinterTimeCostTracingScriptOnTimer3 {
...
//	private static Map<String, String> timecost = BTraceUtils.newHashMap();
	...
	@OnMethod(clazz = "/lerrain\\.tool\\.document\\.typeset\\.element\\..*/", method = "/.*/")
...
//	}
	...
	@OnMethod(clazz = "/lerrain\\.tool\\.document\\.typeset\\.element\\..*/", method = "/.*/", location = @Location(Kind.RETURN))
