...
/**
 * Main entry point for the application. Simulates multiple random accesses to
 * the cache.
 *
 * @author PiotrNowicki
 *
...
public class Executor {
	...
	/**
	 * Helper method for random cache key generation. The number is from the
	 * range *
	 * 
	...
	/**
	 * Helper method for random sleep time generation. The sleep time is from
	 * the range *
	 * 
	...
	void sleep() {
		...
		try {
			log.log(Level.INFO, "Going to sleep for {0} milliseconds", sleepTime);
