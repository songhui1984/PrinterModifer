...
public class DataAccessor {
	...
	/**
	 * Accesses the {@link Data} stored in cache under given <code>key</code>.
	 * If the data can't be found in the cache, it <strong>creates</strong> a
	 * new instance of it.
	 *
	 * @param key
	...
	public Data getData(String key) {
		...
		/*
		 * It's a weak reference, so we need to check if it doesn't store a null
		 * value.
		 */
