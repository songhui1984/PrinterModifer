...
//	private boolean nextHeader = true; //到下一页时，是否重画表头
	...
	private void initStyle(TypesetParameters tvs,ResourceOps ops)
	{
	...
	private DocumentPanel headerOf(TypesetParameters tvs, String[][] content, int[] cols,ResourceOps ops)
	{
	...
	private int insertTable(TypesetParameters tvs, DocumentPanel dPanel, int y, String[][] content, 
			boolean header, LexColor color, LexColor bgColor, int tableLine,
			LexColor borderColor, int[] aligns, int[] cols,ResourceOps ops)
	{
